...
function(PROTOBUF_GENERATE_CPP_PLUGIN SRCS HDRS)
  cmake_parse_arguments(protobuf "" "EXPORT_MACRO;DESCRIPTORS;PLUGIN" "" ${ARGN})
  ...
  if(protobuf_PLUGIN)
      set(_plugin "--plugin=protoc-gen-${protobuf_PLUGIN}")
  endif()
  ...
  foreach(FIL ${PROTO_FILES})
    ...
    add_custom_command(
      ...
      COMMAND  protobuf::protoc
               ...
               "${_plugin}" 
               "--typegen_out=${CMAKE_CURRENT_BINARY_DIR}"
